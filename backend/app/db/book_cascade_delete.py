...
async def soft_delete_book(book_id: str, user_auth_id: str) -> bool:
    """
...
async def restore_soft_deleted_book(book_id: str, user_auth_id: str) -> bool:
    """
