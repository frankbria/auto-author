    ...
    <div className="bg-muted border border-border rounded-lg p-8">
      ...
      <div className="flex flex-col items-center mt-8">
        ...
        <div className="bg-card border border-border rounded-lg p-6 w-full max-w-lg">
          <h3 className="text-muted-foreground font-medium mb-4 text-center">AI Processing Steps</h3>
            ...
            {steps.map((step, index) => (
              <div key={index} className="flex items-center">
                ...
                <span className={`text-sm ${
                  index <= currentStep ? 'text-muted-foreground' : 'text-muted-foreground'
                }`}>
                  {step}
                </span>
              </div>
        ...
        <div className="mt-8 bg-muted/50 border border-border rounded-lg p-4 w-full max-w-lg">
          <h4 className="text-muted-foreground font-medium mb-2 text-center">🤖 What&apos;s happening:</h4>
