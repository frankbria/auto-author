  ...
  return (
    <div className="bg-muted border border-border rounded-lg p-8">
      <div className="text-center mb-6">
        <div className="w-16 h-16 bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-300 dark:border-yellow-700 rounded-full flex items-center justify-center mx-auto mb-4">
          <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 text-yellow-700 dark:text-yellow-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <div className="bg-card border border-border rounded-lg p-6 mb-6">
        <h3 className="text-muted-foreground font-medium mb-4">Analysis Results</h3>

        <div className="space-y-4">
          <div className="flex justify-between items-center">
            <span className="text-muted-foreground">Confidence Score</span>
            <span className="text-foreground font-medium">{Math.round(readiness.confidence_score * 100)}%</span>
          </div>
            <div className="flex justify-between items-center">
          ...
          <div className="flex justify-between items-center">
            <span className="text-muted-foreground">Meets Requirements</span>
            <span className={`font-medium ${readiness.meets_minimum_requirements ? 'text-green-700 dark:text-green-400' : 'text-red-700 dark:text-red-400'}`}>
        ...
        <div className="mt-6 pt-6 border-t border-border">
          <h4 className="text-muted-foreground font-medium mb-3">AI Analysis</h4>
          <p className="text-muted-foreground text-sm mb-4">{readiness.analysis}</p>

          {readiness.suggestions.length > 0 && (
            <>
              <h4 className="text-muted-foreground font-medium mb-3">Suggestions for Improvement</h4>
        ...
        <button
          onClick={onRetry}
          className="flex-1 px-6 py-3 bg-secondary hover:bg-secondary/80 text-secondary-foreground font-medium rounded-md transition-colors"
        >
          Check Again
        </button>
      </div>
      ...
      <div className="mt-6 bg-muted/50 border border-border rounded-lg p-4">
        <h4 className="text-muted-foreground font-medium mb-2">💡 Tips for a better summary:</h4>
