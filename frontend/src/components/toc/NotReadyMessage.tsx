  ...
  return (
    <div className="bg-gray-800 border border-gray-700 rounded-lg p-8">
      ...
      <div className="bg-gray-900 border border-gray-700 rounded-lg p-6 mb-6">
        <h3 className="text-gray-300 font-medium mb-4">Analysis Results</h3>

        <div className="space-y-4">
          <div className="flex justify-between items-center">
            <span className="text-gray-400">Confidence Score</span>
            <span className="text-gray-100 font-medium">{Math.round(readiness.confidence_score * 100)}%</span>
          </div>
            <div className="flex justify-between items-center">
        ...
        <div className="mt-6 pt-6 border-t border-gray-700">
          <h4 className="text-gray-300 font-medium mb-3">AI Analysis</h4>
          <p className="text-gray-400 text-sm mb-4">{readiness.analysis}</p>

          {readiness.suggestions.length > 0 && (
            <>
              <h4 className="text-gray-300 font-medium mb-3">Suggestions for Improvement</h4>
        ...
        <button
          onClick={onRetry}
          className="flex-1 px-6 py-3 bg-gray-700 hover:bg-gray-600 text-gray-100 font-medium rounded-md transition-colors"
        >
          Check Again
        </button>
      </div>
      ...
      <div className="mt-6 bg-gray-800/50 border border-gray-700 rounded-lg p-4">
        <h4 className="text-gray-300 font-medium mb-2">💡 Tips for a better summary:</h4>
